    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Navbar brand -->
                <a class="text-reset me-3" href="painel.php">
                <h5 class="mt-3" style="color: white;">FastImóveis</h5>
                </a>
                <a class="text-reset me-3" href="calculadora.php">
                <h6 class="mt-3" style="color: white;">Calculadora</h5>
                </a>
            </div>
...
// Define o fuso horário para o horário do Brasil
...
// Exibe a data e hora
echo 'Data e hora: ' . $dataAtual->format('d-m-Y H:i:s') . PHP_EOL;
?>
